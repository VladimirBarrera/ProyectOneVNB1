...
<body style="background-color: #367BB6;>
  <div class="container">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                ...
                <div class="row mt-2 px-1 justify-content-center mt-5">
                    ...
                    <div class="row mt-2 justify-content-center">
                      <img src="img/LogoRiac.png" alt="iscjlchavezG" style="width: 250px;">
                    </div>
                    <div class="row mt-2">
                      ...
                      <div class="row mt-4 mb-2 justify-content-center">
                          <div class="col-sm-8 col-md-8 col-lg-8">
                              <div class="d-grid gap-2">
                                <input type="submit" value="Ingresar" name="btn-ingresar" id="btn-ingreso" class="btn btn-sm btn-outline-light bg-gradient rounded-pill">
                              </div>
                          </div>
                      </div>
                    </form>
